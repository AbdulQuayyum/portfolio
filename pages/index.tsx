  ...
  return (
    <motion.div className="flex flex-col flex-grow px-6 pt-1 "
      ...
      <h6 className="my-3 text-base font-medium">
        I am a Software Developer using JavaScript || TypeScript || React.Js || Vue.Js || Next.Js || Express.Js || Node.Js || Flutter || React-Native Technologies to solve problems,
      ...
      >
        ...
        <motion.div className="grid gap-8 my-3 md:grid-cols-1"
          variants={stagger}
          initial="initial"
          animate="animate">
